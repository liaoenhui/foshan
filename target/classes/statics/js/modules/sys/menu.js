    ...
    methods: {
    	getDomain: function(){
            ...
            $.get(baseURL + "sys/sysdomain/listAll", function(r){
                ...
                var node = domainZtree.getNodeByParam("domainId", vm.menu.domainId);
                if(node != null){
                	domainZtree.selectNode(node);

                    vm.menu.domainName = node.name;
                }
            })
        },
...
//            vm.showList = false;
//            vm.title = "新增";
//            vm.menu = {parentName:null,parentId:0,type:1,orderNum:0,domainId:0,domainName:null};
//            vm.getMenu();
//            vm.getDomain();
        	...
        	if(menuId==null){
        	 ...
        	 $.get(baseURL + "sys/menu/info/"+menuId, function(r){
                 ...
                 if(r.menu.type==0){
	                 ...
	                 vm.menu.parentId=r.menu.menuId;
                 }else if(r.menu.type==1){
        ...
        domainTree: function(){
            layer.open({
                ...
                btn1: function (index) {
                    ...
                    //选择上级部门
                    vm.menu.domainId = node[0].domainId;
                    vm.menu.domainName = node[0].name;
...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '所属域名称', field: 'domainName', align: 'center', valign: 'middle', sortable: true, width: '180px'},
