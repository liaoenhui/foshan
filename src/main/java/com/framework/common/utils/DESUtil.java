...
public class DESUtil {
	...
	public static String decrypt(String str){
		DESUtil des = new DESUtil(NORMAL_SALT);
		// DES 加密文件
	...
	private static String NORMAL_SALT = "zY_daTa";
	public static void main(String[] args) throws Exception {
		String enstr =  DESUtil.encrypt("123456");
		String enstr2 =  DESUtil.encrypt("123456");
		String destr = DESUtil.decrypt(enstr);
		System.out.println(enstr);
		System.out.println(enstr2+"|||"+DESUtil.encrypt("123456"));
