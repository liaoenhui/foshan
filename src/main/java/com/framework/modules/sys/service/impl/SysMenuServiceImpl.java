...
//		}
	...
	public List<SysMenuEntity> queryList(Map<String, Object> params) {
		...
		List<SysMenuEntity> list = this.selectList(new EntityWrapper<SysMenuEntity>()
				.eq(domainId!=null,"domain_id", domainId).addFilterIfNeed(params.get(Constant.SQL_FILTER) != null, (String) params.get(Constant.SQL_FILTER)));
